...
public:
    ...
    cover_provider();
    ~cover_provider(); // shutdown and pool drain
...
// Runs on cover_provider's m_response_pool. Deliberately no Q_OBJECT here:
...
{
public:
    cover_image_response(covers::live::cover_provider *provider, const QString &id, const QSize &requestedSize);
...
private:
    covers::live::cover_provider *m_provider;
    QString m_id;
